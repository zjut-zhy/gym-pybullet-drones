"""SEAM-RL Phase 1 -- SAC-guided Go-Explore.
...
Phase 1 is identical to sge_mamba_rl: trains a SAC explorer online with
Go-Explore's archive mechanism. The archive and demos are then used
by Phase 2 (robustify.py) which trains the EA-Mamba policy.
"""
...
from gym_pybullet_drones.our_experiments.sge_ea_mamba_rl.config import SGEConfig


# ---------------------------------------------------------------------------
#  SAC Explorer (lightweight, no SB3 dependency for Phase 1)
# ---------------------------------------------------------------------------
...
def train(cfg: SGEConfig) -> None:
    ...
    print("=" * 70)
    print("SEAM-RL Phase 1 -- SAC-Guided Go-Explore")
...
def _parse_args() -> SGEConfig:
    parser = argparse.ArgumentParser(
        description="SEAM-RL Phase 1: SAC-Guided Go-Explore")
    cfg = SGEConfig()
