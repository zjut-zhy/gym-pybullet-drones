"""SGE-MambaRL -- GUI demo: load trained Mamba policy and visualise.
...
def run_demo(
    ...
    # -- Load SB3 model with custom Mamba policy --
    print(f"Loading model from {model_path} ...")
    custom_objects = {
        "policy_class": MambaActorCriticPolicy,
    }
    ...
    for ep in range(1, n_episodes + 1):
        ...
        # Reset Mamba hidden state for new episode
...
def main():
    parser = argparse.ArgumentParser(
        description="SGE-MambaRL demo: visualise trained Mamba policy")
