"""SGE-EA (ablation) -- GUI demo: load trained EA policy and visualise.
...
def run_demo(
    ...
    custom_objects = {
        "policy_class": EAActorCriticPolicy,
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="SGE-EA (ablation) demo: visualise trained EA policy")
